  ...
  return (
    <>
      ...
      <div className="mx-5 lg:mx-20">
        <div className="container mx-auto p-2 flex gap-2 relative ">
          <div className=" hidden  w-[20%] ps-3 pt-2 sticky top-24 h-max p-1 mx-5 my-4 myshadow rounded-sm bg-white border hover:border-blue-600  lg:flex flex-col">
            ...
            <div className="p-4 flex flex-col gap-3">
              ...
              {hotalbackup && hotalbackup.info && seepagination && (
                <div className="flex justify-between p-2 px-5">
                  <button
                    className={`${page == 0 ? "bg-gray-700 cursor-not-allowed" : "bg-black"
                  ...
                  <button
                    className={`${page >= hotalbackup.info.count - 1
